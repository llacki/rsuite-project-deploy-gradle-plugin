...
import com.marklogic.client.modulesloader.xcc.*
 ...
 * </p>
 */
public class RSuiteXccAssetLoader extends XccAssetLoader  {
    ...
    public List<LoadedAsset> loadAssetsViaXcc(String... paths) {
        ...
        try {
            for (String path : paths) {
				...
				if (bulkLoad) {
					try {
						activeSession.insertContent(bulkContents.toArray(new Content[bulkContents.size()]));
